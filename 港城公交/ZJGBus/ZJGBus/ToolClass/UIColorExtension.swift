...
{
    // MARK: - 主要逻辑
    private class func proceesHex(_ hex: String,_ alpha: CGFloat) -> UIColor{
        /** 如果传入的字符串为空 */
        if hex.isEmpty {
        ...
        var hHex = hex.trimmingCharacters(in:NSCharacterSet.whitespaces).uppercased()
